...
namespace EMalkhana
{
    public partial class PoliceStation : System.Web.UI.Page
    {
        ...
        protected void frmVwAdmin_ItemInserting(object sender, FormViewInsertEventArgs e)
        {
            ...
            CheckBox isPS = (CheckBox)frmVwAdmin.FindControl("isPS");
            CheckBox isOnEMalkhana = (CheckBox)frmVwAdmin.FindControl("isOnEMalkhana");
            ...
            if (boolDoAction == true)
            {
                ...
                cmd.CommandText = "sp_department_add";
                cmd.Parameters.AddWithValue("@numId", numUniqueID.Text);
                cmd.Parameters.AddWithValue("@isPS", isPS.Checked);
                cmd.Parameters.AddWithValue("@onMalkhana", isOnEMalkhana.Checked);
        ...
        protected void lstVwAdmin_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "DELETERECORD")
            {
                ...
                cmd.CommandText = "update department set isActive = 0 WHERE id = " + e.CommandArgument.ToString();
                cmd.ExecuteNonQuery();
