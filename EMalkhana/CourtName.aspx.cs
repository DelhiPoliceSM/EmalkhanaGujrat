...
namespace EMalkhana
{
    public partial class CourtName : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("CourtName.aspx");
        }
        ...
        protected void frmVwAdmin_ItemInserting(object sender, FormViewInsertEventArgs e)
        {
            ...
            if (boolDoAction == true)
            {
                ...
                cmd.CommandText = "sp_courtname_add";
        ...
        protected void lstVwAdmin_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "DELETERECORD")
            {
                ...
                cmd.CommandText = "update courtname set isActive = 0 WHERE id = " + e.CommandArgument.ToString();
                cmd.ExecuteNonQuery();
