...
namespace EMalkhana
{
    public partial class FSL : System.Web.UI.Page
    {
        ...
        protected void lstVwAdmin_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "DELETERECORD")
            {
                ...
                cmd.CommandText = "update fsl set isActive = 0 WHERE id = " + e.CommandArgument.ToString();
                cmd.ExecuteNonQuery();
