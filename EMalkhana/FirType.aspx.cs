...
namespace EMalkhana
{
    public partial class FirType : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("FirType.aspx");
        }
        ...
        protected void frmVwAdmin_ItemInserting(object sender, FormViewInsertEventArgs e)
        {
            ...
            if (boolDoAction == true)
            {
                ...
                cmd.CommandText = "sp_fir_type_add";
        ...
        protected void lstVwAdmin_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "DELETERECORD")
            {
                ...
                cmd.CommandText = "update firType set isActive = 0 WHERE id = " + e.CommandArgument.ToString();
                cmd.ExecuteNonQuery();
