<%@ Page Title="" Language="C#" MasterPageFile="Master.Master" AutoEventWireup="true" CodeBehind="ReceiptSearch.aspx.cs" Inherits="EMalkhana.ReceiptSearch" %>
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">મુદ્દામાલ પાવતી નઁ.  દ્વારા શોધો</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">હોમ</a></li>
                            <li class="breadcrumb-item active" aria-current="page">મુદ્દામાલ પાવતી નઁ.  દ્વારા શોધો</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                <div style="width: 90%">
                                    <h3 class="card-title mb-0">મુદ્દામાલ પાવતી નઁ. હેઠળની યાદી યાદી</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="bg-transparent border-bottom-0">FIR નંબર</th>
                    ...
                    <asp:SqlDataSource ID="mudMovementView" runat="server" ConnectionString="<%$ ConnectionStrings:mysqlConnection %>" SelectCommand="sp_receiptNum_Search" SelectCommandType="StoredProcedure" ProviderName="<%$ ConnectionStrings:mysqlConnection.ProviderName %>">
                        <SelectParameters>
                            <asp:ControlParameter Name="strReceiptNum" ControlID="rcNum" />
                        </SelectParameters>
                    </asp:SqlDataSource>
