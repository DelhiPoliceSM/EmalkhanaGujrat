...
<head>
    ...
    <title>ઈ-પ્રોહી મુદ્દામાલરૂમ</title>
    <link
        rel="canonical"
                            ...
                            <div class="card-body">
                                ...
                                <form id="frm" runat="server"
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="tb-email">ફોન નંબર</label>
                                        <div class="invalid-feedback" style="display: block">
                                            <asp:RequiredFieldValidator ID="re" SetFocusOnError="true" ValidationGroup="login" ControlToValidate="tbEmail" runat="server" ErrorMessage="ફોન નંબર જરૂરી છે"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="text-password">પાસવર્ડ</label>
                                        <div class="invalid-feedback" style="display: block">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" SetFocusOnError="true" ValidationGroup="login" ControlToValidate="textPassword" runat="server" ErrorMessage="પાસવર્ડ જરૂરી છે"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="ms-auto">
                                            <a
                                                ...
                                                id="to-recover"
                                                class="fw-bold">પાસવર્ડ ભૂલી ગયા છો?</a>
                                        </div>
                                    </div>
                                    <div
                                        class="d-flex align-items-stretch button-group mt-4 pt-2">
                                        <asp:Button ID="btnSubmit" ValidationGroup="login" runat="server" OnClick="btnSubmit_Click" Style="background-color: bisque; color: black" class="btn btn-info btn-lg px-4" Text="સાઇન ઇન કરો"></asp:Button>
