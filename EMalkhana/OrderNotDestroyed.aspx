<%@ Page Title="" Language="C#" MasterPageFile="Master.Master" AutoEventWireup="true" CodeBehind="OrderNotDestroyed.aspx.cs" Inherits="EMalkhana.OrderNotDestroyed" %>
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Ordered But Not Destroyed</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">હોમ</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Ordered But Not Destroyed</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                <div style="width: 90%">
                                    <h3 class="card-title mb-0">Ordered But Not Destroyed</h3>
                                </div>
                            </div>
                            <div class="card-body">
