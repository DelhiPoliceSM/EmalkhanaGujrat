...
namespace EMalkhana
{
    ...
    {
        public DataTable GetFirDetails(int startrows, int pagesize, int numUserId, string txtMudhNo)
        {
            int endrows;
            ...
            cmd.CommandText = "sp_fir_Search_Page_Wise";
        ...
        public int GetFirCount(string txtMudhNo, int numUserId)
        {
            MySqlConnection con = new MySqlConnection(WebConstants.ConnectionString);
            MySqlCommand cmd = new MySqlCommand();
            con.Open();
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "sp_fir_count_Page_Wise";
            cmd.Parameters.AddWithValue("@numUserId", numUserId);
            cmd.Parameters.AddWithValue("@searchText", txtMudhNo == null ? "" : txtMudhNo);
            MySqlDataReader dr = cmd.ExecuteReader();
            int rowCount = 0;
        ...
        public DataTable GetReceiptDetails(int startrows, int pagesize, int numUserId, string txtMudhNo)
        {
            int endrows;
            //startrows starts from zero
            startrows = startrows + 1;
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "sp_receipt_Search_Page_Wise";
            cmd.Parameters.AddWithValue("@numUserId", numUserId);
            cmd.Parameters.AddWithValue("@searchText", txtMudhNo == null ? "" : txtMudhNo);
            cmd.Parameters.AddWithValue("@startRows", startrows);
            cmd.Parameters.AddWithValue("@endRows", endrows);
        ...
        public int GetReceiptCount(string txtMudhNo, int numUserId)
        {
            MySqlConnection con = new MySqlConnection(WebConstants.ConnectionString);
            MySqlCommand cmd = new MySqlCommand();
            con.Open();
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "sp_receipt_count_Page_Wise";
            cmd.Parameters.AddWithValue("@numUserId", numUserId);
            cmd.Parameters.AddWithValue("@searchText", txtMudhNo == null ? "" : txtMudhNo);
            MySqlDataReader dr = cmd.ExecuteReader();
            int rowCount = 0;
