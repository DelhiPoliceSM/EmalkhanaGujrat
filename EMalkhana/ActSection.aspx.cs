...
namespace EMalkhana
{
    public partial class ActSection : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ActSection.aspx");
        }
        ...
        protected void frmVwAdmin_ItemInserting(object sender, FormViewInsertEventArgs e)
        {
            ...
            if (boolDoAction == true)
            {
                ...
                cmd.CommandText = "sp_act_section_add";
        ...
        protected void lstVwAdmin_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "DELETERECORD")
            {
                ...
                cmd.CommandText = "update act_section set isActive = 0 WHERE id = " + e.CommandArgument.ToString();
                cmd.ExecuteNonQuery();
