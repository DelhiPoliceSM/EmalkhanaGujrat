        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Police Station</h1>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Enter New PoliceStation Here</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <asp:FormView ID="frmVwAdmin" runat="server" Width="100%" DataKeyNames="id"
                                    ...
                                    <EditItemTemplate>
                                        <div class="row col-md-12">
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <label for="firstName" class="col-md-3 form-label">Police Station Name</label>
                                                    <div class="col-md-9">
                                                        <asp:TextBox runat="server" ValidationGroup="a" CssClass="form-control" ID="txtName" placeholder="Enter Police Station Name" type="text" Text='<%# Bind("name") %>' />
                                                        <asp:RequiredFieldValidator ValidationGroup="a" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" runat="server" ID="txtNameRequiredField" ErrorMessage="Please enter a Police Station Name" ControlToValidate="txtName" ></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <label for="firstName" class="form-label">Is Police Station?</label>
                                                    <div class="col-md-9">
                                                        <asp:CheckBox runat="server" ID="isPS" placeholder="Is Police Station" type="text" Checked='<%# Eval("isPS").ToString() == "1"?true:false%>' />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <label for="firstName" class="form-label">Is on EMalkhana?</label>
                                                    <div class="col-md-9">
                                                        <asp:CheckBox runat="server" ID="isOnEMalkhana" placeholder="Is Not on E Malkhana" type="text" Checked='<%# Eval("onEMalkhana").ToString() == "1"?true:false%>' />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <label for="firstName" class="form-label">Is Police Station?</label>
                                                    <div class="col-md-9">
                                                        <asp:CheckBox runat="server" ID="isPS" placeholder="Is Police Station" type="text" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <label for="firstName" class="form-label">Is on EMalkhana?</label>
                                                    <div class="col-md-9">
                                                        <asp:CheckBox runat="server" ID="isOnEMalkhana" placeholder="Is on E Malkhana" type="text"  />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                <div style="width: 90%">
                                    <h3 class="card-title mb-0">Police Station List</h3>
                                </div>
                                <div>
                                    <asp:Button runat="server" CssClass="btn btn-primary" Text="Create New Police Station" OnClick="btnAddNew_Click"></asp:Button>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="bg-transparent border-bottom-0">Police Station Name</th>
                                                        <th class="bg-transparent border-bottom-0">Is Police Station</th>
                                                        <th class="bg-transparent border-bottom-0">Is On E Malkhana</th>
