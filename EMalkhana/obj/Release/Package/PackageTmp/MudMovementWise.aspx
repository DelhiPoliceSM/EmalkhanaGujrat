<%@ Page Title="" Language="C#" MasterPageFile="Master.Master" AutoEventWireup="true" CodeBehind="MudMovementWise.aspx.cs" Inherits="EMalkhana.MudMovementWise" %>
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Mud Movement Wise</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Mud Movement Wise</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                <div style="width: 90%">
                                    <h3 class="card-title mb-0">Mud Movement Wise</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <asp:ListView ID="lstView" runat="server" DataKeyNames="id" DataSourceID="mudMovementView"
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="text-muted fs-14 fw-semibold">
                                                <asp:Label ID="ToDepartment" runat="server" Text='<%# Eval("goingAt") %>' /></td>
                                            </td>
                                            <td class="text-muted fs-14 fw-semibold">
                                                <asp:Label ID="Status" runat="server" Text='<%# Eval("mdRecieve").ToString()=="1"?"ACCECPTED":Eval("mdActive").ToString()=="1"?"PENDING":"REJECTED" %>' /></td>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <LayoutTemplate>
                                            ...
                                            <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="bg-transparent border-bottom-0">To Department</th>
                    ...
                    <asp:SqlDataSource ID="mudMovementView" runat="server" ConnectionString="<%$ ConnectionStrings:mysqlConnection %>" SelectCommand="sp_mudmovement_wise_Search" SelectCommandType="StoredProcedure" ProviderName="<%$ ConnectionStrings:mysqlConnection.ProviderName %>">
                        <SelectParameters>
                            <asp:SessionParameter DefaultValue="0" Name="numUserId" SessionField="numUserId" Type="Int32" />
                            <asp:ControlParameter Name="numMudNo" ControlID="mudNo" />
