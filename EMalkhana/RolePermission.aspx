        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">ભૂમિકાની પરવાનગી</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">હોમ</a></li>
                            <li class="breadcrumb-item active" aria-current="page">ભૂમિકાની પરવાનગી</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">અહીં નવી ભૂમિકાની પરવાનગી દાખલ કરો</h3>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row col-md-12">
                                            <div class="col-md-6" style="display:none">
                                                <div class="mb-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:TextBox runat="server" Enabled="true" ValidationGroup="a" CssClass="form-control" ID="numUniqueId" placeholder="રોલ નામ દાખલ કરો" type="text" Text='<%# Bind("id") %>' />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    <label for="firstName" class="col-md-3 form-label">રોલ નામ</label>
                                                    <div class="col-md-9">
                                                        <asp:TextBox runat="server" Enabled="false" ValidationGroup="a" CssClass="form-control" ID="role" placeholder="રોલ નામ દાખલ કરો" type="text" Text='<%# Bind("name") %>' />
                                                        <asp:RequiredFieldValidator ValidationGroup="a" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" runat="server" ID="RequiredFieldValidator1" ErrorMessage="રોલ નામ દાખલ કરો" ControlToValidate="role" ></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                <div style="width: 90%">
                                    <h3 class="card-title mb-0">ભૂમિકા પરવાનગી યાદી</h3>
                                </div>
                            </div>
                            <div class="card-body">
