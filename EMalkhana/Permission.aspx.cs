...
namespace EMalkhana
{
    public partial class Permission : System.Web.UI.Page
    {
        ...
        protected void frmVwAdmin_ItemInserting(object sender, FormViewInsertEventArgs e)
        {
            ...
            TextBox txtUrl = (TextBox)frmVwAdmin.FindControl("txtUrl");
        ...
        protected void lstVwAdmin_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "DELETERECORD")
            {
                ...
                cmd.CommandText = "update permission set isActive = 0 WHERE id = " + e.CommandArgument.ToString();
                cmd.ExecuteNonQuery();
